...
INPUTLIST=/home/twongjirad/working/larbys/gen2/container_u20_env/work/flashmatchdata_petastorm/data_prep/tuftscluster/corsika_example_list.txt
FILEIDLIST=/home/twongjirad/working/larbys/gen2/container_u20_env/work/flashmatchdata_petastorm/data_prep/tuftscluster/fileidlist.txt
...
for ((i=0;i<${STRIDE};i++)); do
    ...
    larcvtruth_inputpath=$(echo $inputfile | sed 's|supera|larcvtruth|g')
